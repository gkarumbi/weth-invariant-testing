...
contract Handler is CommonBase, StdCheats, StdUtils{
    ...
    function transfer(uint256 actorSeed, uint256 toSeed, uint256 amount) public useActor(actorSeed) countCall("transfer"){
        address _to = _actors.rand(toSeed);
        amount = bound(amount, 0, weth.balanceOf(currentActor));
    ...
    function transferFrom(uint256 actorSeed, uint256 fromSeed, uint256 toSeed, bool _approve, uint256 amount) public useActor(actorSeed) countCall("transferFrom"){
